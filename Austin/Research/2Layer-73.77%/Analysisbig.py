...
MODEL_NAME = "BIG_RUN-2LAYER-4000.model"
...
if os.path.exists('{}.meta'.format(MODEL_NAME)):
    ...
    model.fit(np.array(X_train) , y_train ,validation_set = (np.array(X_val), y_val),n_epoch = 4000, snapshot_step = 5000, show_metric = True,run_id = MODEL_NAME)
    model.save("//Desktop//"+ MODEL_NAME)
