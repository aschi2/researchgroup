...
MODEL_NAME = "BIG-RUN-3LAYER-with-elevation-with-soft"
...
test_net = tfl.layers.core.fully_connected(test_net,2,activation='softmax',bias = True,name = 'To_Output')
#                                           This learning rate seems to marginally help with local minimums
test_net = tfl.layers.estimator.regression(test_net, name = "output",learning_rate = .001)
